Pro EACF, Termal_conductivity, All_data
    common basic_data
    common Column
    Kinetic_Energy , All_data, Ek_sum_item
    Potential_Energy, All_data, Ep_sum_item_x
    ...
    openw,data_building,file_path+'EACF/dat_analysis.txt',/get_lun
    printf  ,data_building,FORMAT='(f0)' ,C_Lambda
    close   ,data_building
